...
bot = discord.Client()
prefix = 'c!' , 'C!' ,'charlie ','c' , '<@574526146641920001> ' , 'C'
...
async def on_member_join(member):
    ...
    if server.id == 554641659888140308:
        ...
        wembed=discord.Embed(title="Welcome To The Support Server ", url="https://discordapp.com/oauth2/authorize?client_id=568492275504775178&scope=bot&permissions=8", description=f"\n\n\n Hey There **{member.name}**,\nThanks You For Joining Our Support Server!\nMake Sure to Vote & Share Our Bot to Others :wink:\n\n:link: **Invite Link:** [Link](https://discordapp.com/oauth2/authorize?client_id=568492275504775178&scope=bot&permissions=8) \n**:trophy: Discord Bot List Vote:** [Link](https://discordbots.org/bot/568492275504775178)\n\nThanks For Using Our Bot! Have a Nice Day! :tada:    ", color=0xfa9205)
